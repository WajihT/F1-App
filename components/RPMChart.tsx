...
const RPMChart: React.FC<RPMChartProps> = ({
  ...
  const loadRPMData = async () => {
    ...
    try {
      ...
      Alert.alert('Error', 'Failed to load RPM data');
    } finally {
      setLoading(false);
    }
  };
  ...
  const renderLoadButton = () => (
    <View style={{ alignItems: 'center', marginVertical: 20 }}>
      ...
      >
        ...
        <Text style={{ color: '#fff', fontWeight: '600', fontSize: 16, fontFamily: typography.fontFamily.semiBold }}>Load RPM Chart</Text>
      </TouchableOpacity>
      <Text style={{ 
